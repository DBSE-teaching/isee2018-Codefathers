...
![Steps image]({{site.baseurl}}/_images/requirements/first.jpg "Steps towards the first stable release")
...
![Round 1]({{site.baseurl}}/_images/requirements/artboard2.png "requirement analysis: Round one, Fight!")
...
![Round 2]({{site.baseurl}}/_images/requirements/artboard4.png "requirement analysis: Round two, Fight!")
...
![Round 2]({{site.baseurl}}/_images/useCaseDia.png "useCase Diagram")
...
![logo]({{site.baseurl}}_images/requirements/logo.png "logo")
...
![Logo ideas]({{site.baseurl}}_images/requirements/logosIdeas.jpg "logo2")
...
![Logo ideas]({{site.baseurl}}_images/requirements/logosIdeas2.jpg "logo3")
